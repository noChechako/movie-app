...
export function MovieDetail({ match }) {
    ...
    useEffect(() => {
        const fetchAPI = async () => {
            ...
            setCasts(await fetchCasts(params.id, incPerson));
    ...
    const castList = () => casts.map((c, i) => {
        if (c.img === "https://image.tmdb.org/t/p/w200null")
            c.img = "https://s.clipartkey.com/mpngs/s/11-118575_question-mark-png-file.png"
        return (
    ...
    async function changeIncPersons(e) {
        incPerson += 4;
        e.preventDefault();
        console.log(casts)
        setCasts(await fetchCasts(params.id, incPerson));
    ...
    async function changeDecPersons(e) {
        incPerson -= 4;
        e.preventDefault();
    ...
    return (
        <div className="container">
            ...
            <div className="row mt-3">
                <div className="col">
                    {/* <div className="float-left" onClick={changeDecPersons}>
                        <i className="far fa-arrow-alt-circle-left"></i>
                    </div> */}
                    <div className="float-right" onClick={changeIncPersons}>
                        <i className="far fa-arrow-alt-circle-right"></i>
                    </div>
                </div>
            </div>
            <div className="row mt-3">{castList(incPerson)}</div>
